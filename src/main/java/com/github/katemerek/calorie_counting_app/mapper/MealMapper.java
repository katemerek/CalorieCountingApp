...
public class MealMapper {
    ...
    public Meal toMeal(MealToAddDto mealToAddDto) {
        Meal meal = new Meal();
        meal.setType(TypeOfMeal.valueOf(mealToAddDto.getType()));
    ...
    public MealDailyDto toMealDto(Meal meal) {
        ...
        mealDailyDto.setType(String.valueOf(meal.getType()));
    ...
    public MealHistoryDto toMealDto3(Meal meal) {
        ...
        mealHistoryDto.setType(String.valueOf(meal.getType()));
